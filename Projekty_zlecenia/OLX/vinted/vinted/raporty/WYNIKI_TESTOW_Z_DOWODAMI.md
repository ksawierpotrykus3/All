...
Data: 2026-08-26
Cel: udokumentować z pełnymi dowodami wyniki testów wykonanych na koncie `weraa13` (id 112079277), w tym pierwszy REALNY test rezerwacji na własnym przedmiocie.
...
- **Wynik:** HTTP **200**
- **Potwierdzenie tożsamości:** odpowiedź zawiera `"login":"weraa13"`, `"id":112079277`.
- **Dowód (fragment odpowiedzi):**
```json
{"user":{"id":112079277,"anon_id":"1b223db1-6851-42ab-80b1-dddef1675fab","login":"weraa13","country_id":15,...}}
```
...
- **Endpoint:** `GET /api/v2/catalog/items?user_id=112079277&page=1&per_page=20`
...
- **Wynik:** HTTP 200
- **Dowód własności:** w HTML strony występuje link `member/112079277-weraa13` (jedyne trafienie), co potwierdza, że przedmiot należy do konta weraa13.
- **Fragment z dowodu:** `MEMBER LINKS: [('112079277', 'weraa13')]`
...
| Plik | Opis |
|---|---|
| `dane/cookies_fresh.txt` | Świeże cookies konta weraa13 (Netscape format) |
