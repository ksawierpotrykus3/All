#!/usr/bin/env python3
"""
F10 Hybrid Test v3: curl_cffi + extracted browser state
Correct endpoint from HAR: POST /api/v2/purchases/checkout/build
"""
import json
import time
import sys
...
def test_strategy(strategy):
    ...
    try:
        # Step 1: POST /api/v2/purchases/checkout/build
        print(f"  Step 1: POST /api/v2/purchases/checkout/build...")
        body = {
            "item_id": int(ITEM_ID),
            "quantity": 1,
        ...
        if not purchase_items:
            print(f"  No purchase_items in response")
            return None
...
def main():
    print("F10 Hybrid Test v3: Full Checkout Flow (Correct Endpoint)")
    print("=" * 60)
