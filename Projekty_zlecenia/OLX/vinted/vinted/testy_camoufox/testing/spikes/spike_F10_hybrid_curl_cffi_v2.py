#!/usr/bin/env python3
"""
F10 Hybrid Test v2: curl_cffi + extracted browser state
Tests the actual checkout flow from HAR:
1. POST /checkout/build -> purchase_id
2. PUT /api/v2/purchases/{purchase_id}/checkout (multiple steps)
3. POST /api/v2/purchases/{purchase_id}/checkout/payment (with x-incognia-request-token)
"""
import json
import time
import sys
...
BASE_HEADERS = {
    ...
    "x-anon-id": "8e7f48f7-2ca3-44d0-8b7e-186ae2afc568",
}

ITEM_ID = "9807925466"

# Available impersonate options from curl_cffi
STRATEGIES = [
    {"name": "chrome146", "impersonate": BrowserType.chrome146, "desc": "Chrome 146"},
    {"name": "chrome145", "impersonate": BrowserType.chrome145, "desc": "Chrome 145"},
    {"name": "chrome142", "impersonate": BrowserType.chrome142, "desc": "Chrome 142"},
    {"name": "chrome136", "impersonate": BrowserType.chrome136, "desc": "Chrome 136"},
    {"name": "chrome131", "impersonate": BrowserType.chrome131, "desc": "Chrome 131"},
    {"name": "chrome124", "impersonate": BrowserType.chrome124, "desc": "Chrome 124"},
    {"name": "chrome123", "impersonate": BrowserType.chrome123, "desc": "Chrome 123"},
    {"name": "chrome120", "impersonate": BrowserType.chrome120, "desc": "Chrome 120"},
    {"name": "chrome119", "impersonate": BrowserType.chrome119, "desc": "Chrome 119"},
    {"name": "chrome116", "impersonate": BrowserType.chrome116, "desc": "Chrome 116"},
    {"name": "chrome110", "impersonate": BrowserType.chrome110, "desc": "Chrome 110"},
    {"name": "firefox147", "impersonate": BrowserType.firefox147, "desc": "Firefox 147"},
    {"name": "firefox144", "impersonate": BrowserType.firefox144, "desc": "Firefox 144"},
    {"name": "firefox135", "impersonate": BrowserType.firefox135, "desc": "Firefox 135"},
    {"name": "firefox133", "impersonate": BrowserType.firefox133, "desc": "Firefox 133"},
    {"name": "safari184", "impersonate": BrowserType.safari184, "desc": "Safari 184"},
    {"name": "safari180", "impersonate": BrowserType.safari180, "desc": "Safari 180"},
    {"name": "safari170", "impersonate": BrowserType.safari170, "desc": "Safari 17.0"},
    {"name": "safari155", "impersonate": BrowserType.safari155, "desc": "Safari 15.5"},
    {"name": "edge101", "impersonate": BrowserType.edge101, "desc": "Edge 101"},
]
...
def test_strategy(strategy):
    """Test a single strategy through the full checkout flow."""
    print(f"\n{'='*60}")
    print(f"Strategy: {strategy['name']} ({strategy['desc']})")
    print(f"{'='*60}")
    ...
    try:
        # Step 1: POST /checkout/build
        print(f"  Step 1: POST /checkout/build...")
        body = {
            "item_id": int(ITEM_ID),
            "quantity": 1,
        ...
        # Step 2: PUT /api/v2/purchases/{purchase_id}/checkout (initial)
        print(f"  Step 2: PUT /api/v2/purchases/{purchase_id}/checkout (initial)...")
        body2 = {
            "components": {
                "additional_service": {},
                "payment_method": {},
        ...
        # Step 3: PUT with payment method
        print(f"  Step 3: PUT with payment method...")
        body3 = {
            "components": {
                "additional_service": {},
        ...
        # Step 4: PUT with shipping pickup
        print(f"  Step 4: PUT with shipping pickup...")
        body4 = {
            "components": {
                "additional_service": {},
                "payment_method": {},
        ...
        # Step 5: PUT with shipping rate
        print(f"  Step 5: PUT with shipping rate...")
        body5 = {
            "components": {
                "additional_service": {},
                "payment_method": {},
                "shipping_address": {},
                "shipping_pickup_options": {},
                "shipping_pickup_details": {"rate_uuid": "9c6994ca-684b-4a27-8d1b-1a75d01c7e84"}
            }
        }
        resp = session.put(
            f"https://www.vinted.pl/api/v2/purchases/{purchase_id}/checkout",
        ...
        # Step 6: Final payment with x-incognia-request-token
        print(f"  Step 6: POST /checkout/payment (with incognia token)...")
        if incognia_payload:
            headers["x-incognia-request-token"] = incognia_payload["s"]
...
def main():
    print("F10 Hybrid Test v2: Full Checkout Flow")
    print("=" * 60)
    print(f"Item: {ITEM_ID}")
    print(f"Cookies: {len(COOKIES)} (incl. datadome)")
