# coding: utf-8
"""RETEST rezerwacji na koncie konto_A przez Playwright (realna przegladarka).

Cel: sprawdzic, czy naturalna przegladarka (Chromium) z cookies właścicielka konta A przejdzie
DataDome tam, gdzie curl_cffi dal 403.

BEZPIECZENSTWO:
- rezerwacja TYLKO na wlasny przedmiot właścicielka konta A 9782578256 (potwierdzony przez SSR)
...
def main():
    ...
    with sync_playwright() as p:
        ...
        # Najpierw sprawdzmy, czy jestesmy zalogowani jako konto_A
