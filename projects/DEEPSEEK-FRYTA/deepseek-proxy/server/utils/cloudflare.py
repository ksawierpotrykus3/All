"""Cloudflare Turnstile bypass via Playwright/DrissionPage.

Migrated from the root CloudflareBypasser.py into the server package.
"""
...
class CloudflareBypasser:
    """Bypasses Cloudflare Turnstile verification using DrissionPage."""
